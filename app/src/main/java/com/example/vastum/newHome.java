...
public class newHome extends Fragment {
    ...
    Fragment home,homeproductinfo,active;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        home=new home();
        active=home;
        FragmentManager fm=((Main2Activity) view.getContext()).getSupportFragmentManager();
        fm.beginTransaction().add(R.id.homehost,home,"home").show(home).commit();
        return view;
    }
}
